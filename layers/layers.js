...
//ol.proj.get("EPSG:32635").setExtent([502002.880238, 4262111.983170, 503459.879189, 4263304.215645]);
var wms_layers = [];
...
var format_YOL_18 = new ol.format.GeoJSON();
var features_YOL_18 = format_YOL_18.readFeatures(json_YOL_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32635'});
var jsonSource_YOL_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_YOL_18.addFeatures(features_YOL_18);
var lyr_YOL_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_YOL_18, 
                style: style_YOL_18,
                popuplayertitle: "YOL",
                interactive: false,
                    title: '<img src="styles/legend/YOL_18.png" /> YOL'
                });

lyr_GoogleMaps_0.setVisible(true);lyr_GoogleMaps_1.setVisible(true);lyr_OSMStandard_2.setVisible(true);lyr_AGAC_3.setVisible(true);lyr_AGAC_A_4.setVisible(true);lyr_FOOTEN_5.setVisible(true);lyr_KALDIRIM_6.setVisible(true);lyr_OTOPARK_7.setVisible(true);lyr_REFUJ_8.setVisible(true);lyr_SINIR_9.setVisible(true);lyr_YESIL_A_10.setVisible(true);lyr_BANK_11.setVisible(true);lyr_KAMELYA_12.setVisible(true);lyr_KAMELYA_A_13.setVisible(true);lyr_HAVUZ_A_14.setVisible(true);lyr_HAVUZ_15.setVisible(true);lyr_BINA_A_16.setVisible(true);lyr_BINA_17.setVisible(true);lyr_YOL_18.setVisible(false);
var layersList = [lyr_GoogleMaps_0,lyr_GoogleMaps_1,lyr_OSMStandard_2,lyr_AGAC_3,lyr_AGAC_A_4,lyr_FOOTEN_5,lyr_KALDIRIM_6,lyr_OTOPARK_7,lyr_REFUJ_8,lyr_SINIR_9,lyr_YESIL_A_10,lyr_BANK_11,lyr_KAMELYA_12,lyr_KAMELYA_A_13,lyr_HAVUZ_A_14,lyr_HAVUZ_15,lyr_BINA_A_16,lyr_BINA_17,lyr_YOL_18];
...
lyr_YOL_18.set('fieldAliases', {'FID': 'FID', 'Shape_Leng': 'Shape_Leng', 'OBN': 'OBN', });
...
lyr_YOL_18.set('fieldImages', {'FID': '', 'Shape_Leng': '', 'OBN': '', });
...
lyr_YOL_18.set('fieldLabels', {'FID': 'hidden field', 'Shape_Leng': 'hidden field', 'OBN': 'hidden field', });
lyr_YOL_18.on('precompose', function(evt) {
